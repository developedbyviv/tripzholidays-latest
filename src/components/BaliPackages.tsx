...
const packages = [
  {
    ...
    duration: 3,
    nights: 2,
    title: 'Bali Paradise | Ubud & Seminyak Beach Experience',
    originalPrice: 'INR 89,900',
    discountedPrice: 'INR 63,000',
    rating: '4.5',
    reviews: '(67)',
  },
  {
    ...
    duration: 5,
    nights: 4,
    title: 'Complete Bali Experience | Ubud, Seminyak & Nusa Penida',
    originalPrice: 'INR 1,25,900',
    discountedPrice: 'INR 92,000',
    rating: '4.6',
    reviews: '(58)',
  },
  {
    ...
    duration: 7,
    nights: 6,
    title: 'Bali Grand Tour | Ubud, Seminyak, Nusa Penida & Gili Islands',
    originalPrice: 'INR 1,65,900',
    discountedPrice: 'INR 1,13,000',
    rating: '4.7',
    reviews: '(49)',
  },
];
              ...
              <div className="p-2.5">
                ...
                <div className="mb-1.5">
                  <span className="bg-gradient-to-r from-orange-400 to-orange-600 text-white px-2 py-0.5 rounded text-xs font-medium">
                    Beach Paradise Temples Rice Terraces Islands
                  </span>
                </div>
