  ...
  return (
    <div className="relative h-screen overflow-hidden hero-section">
      ...
      <nav className="relative z-10 mt-6">
        <div className="w-full max-w-6xl mx-auto bg-white bg-opacity-90 backdrop-blur-sm rounded-full px-3 sm:px-4 py-2">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2 sm:space-x-4 lg:space-x-6">
              ...
              {/* WhatsApp Icon */}
              <button 
                className="w-8 h-8 sm:w-10 sm:h-10 bg-green-500 rounded-full flex items-center justify-center hover:bg-green-600 transition-all duration-300 transform hover:scale-110 active:scale-95 shadow-md hover:shadow-lg"
              ...
              {/* Book Now Button */}
              <button 
                className="text-white px-4 py-2 sm:px-6 sm:py-3 rounded-full font-medium transition-all duration-300 text-sm sm:text-base hover:opacity-90 transform hover:scale-105 active:scale-95 shadow-md hover:shadow-lg" 
