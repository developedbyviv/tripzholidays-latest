...
export default function PackageCard({ package: pkg, tags, onViewItinerary, onCall }: PackageCardProps) {
  return (
    <div className="bg-white rounded-lg max-w-xs mx-auto">
      {/* Image Section */}
