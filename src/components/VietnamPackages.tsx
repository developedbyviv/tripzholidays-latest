...
const packages = [
  {
    ...
    duration: 4,
    nights: 3,
    title: 'Vietnam Discovery | Hanoi & Halong Bay Adventure',
    originalPrice: 'INR 1,15,900',
  ...
  },
  {
    ...
    duration: 6,
    nights: 5,
    title: 'Complete Vietnam Experience | Hanoi, Ho Chi Minh & Mekong',
    originalPrice: 'INR 1,55,900',
    discountedPrice: 'INR 1,04,000',
    rating: '4.5',
    reviews: '(39)',
  },
  {
    ...
    duration: 8,
    nights: 7,
    title: 'Vietnam Grand Tour | Hanoi, Ho Chi Minh, Hoi An & Mekong Delta',
    originalPrice: 'INR 1,95,900',
    discountedPrice: 'INR 1,21,000',
    rating: '4.6',
    reviews: '(36)',
  },
];
              ...
              <div className="p-2.5">
                ...
                <div className="mb-1.5">
                  <span className="bg-gradient-to-r from-orange-400 to-orange-600 text-white px-2 py-0.5 rounded text-xs font-medium">
                    Halong Bay Mekong Delta Street Food Culture
                  </span>
                </div>
